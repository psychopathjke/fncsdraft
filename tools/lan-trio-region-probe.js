// ТРИО-ГОД: кто выигрывает ЛАН, когда состав из троих. Копия career-lan-region-probe.
...
(async function(){
  ...
  try{
    localStorage.setItem('fncsdraft_career', JSON.stringify({
      ...
      career:{season:2, size:3, day:'2026-11-20', division:1, earnings:0, balance:0, reach:0,
              tokens:[], log:[], news:[]},
      partner:null}));
    careerEntry();
    ...
    for(let k=0;k<N;k++){
      ...
      ranked.slice(0,10).forEach(t=>{ const rr=regOf(t); out.top10=out.top10||{}; out.top10[rr]=(out.top10[rr]||0)+1; });
